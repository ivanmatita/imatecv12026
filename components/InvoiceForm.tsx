            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
                ...
                <div className="xl:col-span-2 space-y-6">
                    ...
                    <div className="grid grid-cols-1 gap-3">
                        <button onClick={() => handleSave('CERTIFY')} className="py-3 px-4 bg-blue-600 text-white rounded-xl font-black uppercase text-xs tracking-widest hover:bg-blue-700 shadow-xl flex items-center justify-center gap-2 transition-all border-2 border-blue-500 transform active:scale-95">
