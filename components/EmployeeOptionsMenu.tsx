                        ...
                        <div className="py-1">
                            {employee.status !== 'Terminated' && (
                                ...
                                >
                                    ...
                                    <span className="font-medium text-slate-700">Demitir Funcionário</span>
                                </button>
                            )}
                            ...
                            >
                                ...
                                <span className="font-medium text-slate-700">Ficha Pessoal</span>
                            </button>
                            ...
                            {employee.status === 'Terminated' && (
                                ...
                                >
                                    ...
                                    <span className="font-medium text-slate-700">Readmitir</span>
                                </button>
                            )}
                            ...
                            >
                                ...
                                <span className="font-medium text-slate-700">Emitir Contrato</span>
                            </button>
                            ...
                            <button
                                ...
                                className="w-full px-4 py-2.5 text-left hover:bg-blue-50 transition-colors flex items-center gap-3 text-sm"
                            >
                                <Shirt size={18} className="text-orange-600" />
                                <span className="font-medium text-slate-700">Fardas</span>
                            </button>
                        </div>
                    </div>
                </>
