        ...
        <div className="max-w-xl mx-auto animate-in zoom-in-95 duration-300">
            <div className="bg-white rounded shadow-2xl border border-slate-300 overflow-hidden">
                <div className="bg-slate-50 border-b p-4 flex justify-between items-center">
                    <h2 className="w-full text-center text-sm font-black text-slate-700 uppercase tracking-widest">Cadastro de Fornecedor</h2>
                </div>
                <form onSubmit={handleSubmit}>
                    <div className="p-8 space-y-6 bg-white">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <label className="text-xs font-bold text-slate-700 block mb-1">Nome do Fornecedor *</label>
                                <input
                                    required
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label className="text-xs font-bold text-slate-700 block mb-1">Banco</label>
                                <input
                                    className="w-full p-3 border border-slate-300 rounded-xl bg-white/80 shadow-inner outline-none focus:ring-1 focus:ring-blue-500 font-medium text-slate-700"
                                    placeholder="BAI, BFA, BIC"
                                    value={formData.bankInitials || ''}
                                    onChange={e => setFormData({ ...formData, bankInitials: e.target.value })}
                                />
                            </div>
                            <div>
                                <label className="text-xs font-bold text-slate-700 block mb-1">IBAN</label>
                                <input
                                    className="w-full p-3 border border-slate-300 rounded-xl bg-white/80 shadow-inner outline-none focus:ring-1 focus:ring-blue-500 font-mono text-slate-700"
                                    placeholder="AO06..."
                                    value={formData.iban || ''}
                        ...
                        {/* Tipo */}
                        <div>
                            <label className="text-xs font-bold text-slate-700 block mb-1">Tipo de Fornecedor</label>
                            <select
                                ...
                                value={formData.supplierType || 'Fornecedor Não Grupo Nacionais'}
                            ...
                            >
                                ...
                                <option value="nao grupo estrangeiros">Não Grupo Estrangeiros</option>
